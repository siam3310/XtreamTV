    ...
    return rx.el.div(
        rx.el.div(
            rx.el.div(
                ...
                rx.el.input(
                    ...
                    on_change=XtreamState.search_movies.debounce(500),
            ...
            rx.el.div(
                rx.el.select(
                    ...
                    rx.foreach(
                        XtreamState.movie_categories, lambda c: rx.el.option(c, value=c)
                    ),
                    value=XtreamState.movie_selected_category,
                    on_change=XtreamState.filter_movies_by_category,
        ...
        rx.cond(
            ...
            rx.cond(
                ...
                rx.el.div(
                    rx.cond(
                        XtreamState.displayed_movies.length() > 0,
                        rx.el.div(
                            rx.foreach(
                                XtreamState.displayed_movies,
                                lambda m: media_card(m, "clapperboard"),
                            ),
                            class_name=rx.cond(
                                XtreamState.view_mode == "list",
                        ...
                        rx.el.div(
                            rx.el.p(
                                "No movies found", class_name="text-gray-500 text-sm"
                            ),
                    ...
                    rx.cond(
                        ...
                        rx.el.div(
                            rx.el.button(
                                "Load More Movies",
                                on_click=XtreamState.load_more_movies,
                            ...
                            class_name="flex justify-center w-full pb-12",
                        ),
                        rx.el.div(),
                    ),
                    class_name="w-full",
