    ...
    return rx.el.div(
        rx.el.div(
            rx.el.div(
                ...
                rx.el.input(
                    ...
                    on_change=XtreamState.search_series.debounce(500),
            ...
            rx.el.div(
                rx.el.select(
                    ...
                    rx.foreach(
                        XtreamState.series_categories,
                        lambda c: rx.el.option(c, value=c),
                    ),
                    value=XtreamState.series_selected_category,
                    on_change=XtreamState.filter_series_by_category,
        ...
        rx.cond(
            ...
            rx.cond(
                ...
                rx.el.div(
                    rx.cond(
                        XtreamState.displayed_series.length() > 0,
                        rx.el.div(
                            rx.foreach(
                                XtreamState.displayed_series,
                                lambda s: media_card(s, "film"),
                            ),
                            class_name=rx.cond(
                                XtreamState.view_mode == "list",
                        ...
                        rx.el.div(
                            rx.el.p(
                                "No series found", class_name="text-gray-500 text-sm"
                            ),
                    ...
                    rx.cond(
                        ...
                        rx.el.div(
                            rx.el.button(
                                "Load More Series",
                                on_click=XtreamState.load_more_series,
